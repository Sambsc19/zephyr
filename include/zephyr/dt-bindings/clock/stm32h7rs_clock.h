...
#define USBREF_SEL(val)		STM32_CLOCK(val, 15, 8, D1CCIPR_REG)
#define USBPHYC_SEL(val)	STM32_CLOCK(val, 3, 12, D1CCIPR_REG)
#define OTGFS_SEL(val)		STM32_CLOCK(val, 3, 14, D1CCIPR_REG)
